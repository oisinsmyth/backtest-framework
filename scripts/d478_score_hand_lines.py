"""SCORE THE CONSTRUCTIONS AGAINST THE PRINCIPAL'S HAND-DRAWN LINES, bar by bar.
    ...
    uv run python scripts/d478_score_hand_lines.py

THE TARGET. `data/d478_hand_drawn_lines.json`: 140 lines on the twelve page names, drawn one bar
...
THE CONSTRUCTIONS, each read at every panel bar exactly as the trader would have seen it:
  PIVOT      D399's CELL_FINAL, the pivot construction (D476/D477's causal arm)
  GROW       D478's grow-right line (the trading line of D478)
  HYST       D479's line: hysteresis, trend-side breaks, 40% survive cap
...
OUT = REPO / "data" / "d478_hand_scorecard.json"
