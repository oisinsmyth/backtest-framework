...
| | |
|---|---|
| **813 decision records** | D1 → D581, over **544** decision numbers — a pre-registration and its result share one number |
...
| **619 research runners** | in `scripts/`, one-shot by design |
