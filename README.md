...
| | |
|---|---|
| **800 decision records** | D1 → D573, over **536** decision numbers — a pre-registration and its result share one number |
...
| **610 research runners** | in `scripts/`, one-shot by design |
