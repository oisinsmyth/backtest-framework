...
| | |
|---|---|
| **858 decision records** | D1 → D623, over **580** decision numbers — a pre-registration and its result share one number |
...
| **664 research runners** | in `scripts/`, one-shot by design |
