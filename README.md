...
| | |
|---|---|
| **843 decision records** | D1 → D614, over **568** decision numbers — a pre-registration and its result share one number |
...
| **643 research runners** | in `scripts/`, one-shot by design |
