...
| | |
|---|---|
| **846 decision records** | D1 → D618, over **571** decision numbers — a pre-registration and its result share one number |
...
| **644 research runners** | in `scripts/`, one-shot by design |
