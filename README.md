...
| | |
|---|---|
| **837 decision records** | D1 → D614, over **563** decision numbers — a pre-registration and its result share one number |
...
| **637 research runners** | in `scripts/`, one-shot by design |
