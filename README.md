...
found five links that resolve only on the author's disk. Each of the 49 skips (2026-09-16) names
...
docs/
  ...
  decisions/              one record per design call, D1 → D539   [index](docs/decisions/README.md)
...
- [`docs/decisions/`](docs/decisions/README.md) — one file per design decision, D1 → D539; the file and number counts are in the generated block at the top of this page. The index is a curated table for D1–D284 and a generated register below it, and a test fails if any record is in neither half.
