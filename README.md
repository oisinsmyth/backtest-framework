...
| | |
|---|---|
| **819 decision records** | D1 → D584, over **547** decision numbers — a pre-registration and its result share one number |
...
| **624 research runners** | in `scripts/`, one-shot by design |
