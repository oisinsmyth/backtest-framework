...
| | |
|---|---|
| **828 decision records** | D1 → D602, over **556** decision numbers — a pre-registration and its result share one number |
...
| **631 research runners** | in `scripts/`, one-shot by design |
