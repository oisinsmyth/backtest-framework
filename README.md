...
| | |
|---|---|
| **817 decision records** | D1 → D583, over **546** decision numbers — a pre-registration and its result share one number |
...
| **623 research runners** | in `scripts/`, one-shot by design |
