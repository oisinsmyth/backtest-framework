...
| | |
|---|---|
| **769 decision records** | D1 → D556, over **519** decision numbers — a pre-registration and its result share one number |
...
| **596 research runners** | in `scripts/`, one-shot by design |
