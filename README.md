...
| | |
|---|---|
| **812 decision records** | D1 → D580, over **543** decision numbers — a pre-registration and its result share one number |
...
| **618 research runners** | in `scripts/`, one-shot by design |
