...
*Added 2026-09-08, after D397's `[ID]` gate.*
...
D397 rebuilt D280's part-4C composite in order to score one of its terms alone.
...
reproduces the inherited number before anything new is computed. D397's `[ID]`,
