...
modules 57→63, records 830→835, numbers 558→563, highest D600→D607), the encoding ratchet (five `to_csv`
...
difference, so D604's additive row turned it red — widened to membership. **Full suite on the staged tree:
