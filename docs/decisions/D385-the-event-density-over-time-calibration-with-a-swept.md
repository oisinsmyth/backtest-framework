...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D385-the-event-density-over-time-calibration-with-a-swept-sharpening-power.md`. The H1 above is the full title.*
