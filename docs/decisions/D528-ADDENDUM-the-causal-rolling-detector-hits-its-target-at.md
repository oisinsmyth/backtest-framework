...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D528-ADDENDUM-the-causal-rolling-detector-hits-its-target-at-exactly-the-sign-shuffle-rate.md`. The H1 above is the full title.*
