# D501 — ADDENDUM to D500: the bad days are a **regime**, not a habit

**2026-09-12.** Runner [`scripts/d501_worst_day_frequency.py`](../../scripts/d501_worst_day_frequency.py) ·
artifact [`data/d501_worst_day_frequency.json`](../../data/d501_worst_day_frequency.json).
Same cell, window and cost line as [D500](D500-hurdle-P-on-the-D495-candidate-P3-fails.md).
...
D500 asked a binary — does the worst day clear $1,000 — and answered no. The principal's reading
...
That is a question about a **rate**, and a rate is a different object from a max. D500 also never
...
## 4. Three corrections to what D496 and D500 published
...
2. **P3 costs 22% of the account's life, not 16%.** Drawdown alone: 7 deaths, 256 sessions.
   Drawdown **or** a P3 breach: 9 deaths, **199 sessions**. D500's hazard addition understated it
...
3. **A same-day stop at the P3 level buys ZERO life.** Capping every breaching day at −$1,000 —
   ...
   **7 against 7**. **The two extreme days are not what kills the account**; strings of moderate
   2022 losses are. That is the opposite of what D500 §4 assumed: a stop is worth building to
