...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D490-the-principals-range-reversion-rule-buy-the-bottom-5pc-of-yesterdays-range-on-a-volume-spike-target-the-top-5pc-trail-from-the-last-swing-after-the-midpoint-with-a-three-way-data-split.md`. The H1 above is the full title.*
