...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D502-RESULT-the-200-day-SMA-filter-halves-the-candidate-and-there-is-no-trendiness-on-the-daily-clock-to-gate-on.md`. The H1 above is the full title.*
...
pre-registration [D502 PRE-REG](D502-PRE-REG-an-orthogonal-daily-clock-confluence-on-the-hourly.md).
...
It also does **not** contradict [D471](D471-RESULT-the-spread-barely-widens-where-the-moves-are-and-path.md),
