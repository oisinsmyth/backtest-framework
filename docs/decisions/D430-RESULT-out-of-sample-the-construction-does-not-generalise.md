...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D430-RESULT-out-of-sample-the-construction-does-not-generalise-across-names-the-base-touch-effect-does-and-every-layer-on-top-of-it-vanishes.md`. The H1 above is the full title.*
