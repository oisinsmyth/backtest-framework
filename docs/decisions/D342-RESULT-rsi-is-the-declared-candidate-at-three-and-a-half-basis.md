...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D342-RESULT-rsi-is-the-declared-candidate-at-three-and-a-half-basis-points.md`. The H1 above is the full title.*
