...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D492-RESULT-the-hourly-RSI-confirmation-removes-three-quarters-of-the-trades-and-leaves-the-rest-at-zero-below-a-stale-range-control-on-both-roots-no-validation-read.md`. The H1 above is the full title.*
