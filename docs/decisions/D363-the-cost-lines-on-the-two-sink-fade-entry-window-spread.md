...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D363-the-cost-lines-on-the-two-sink-fade-entry-window-spread-execution-bounds-and-cost-aware-sizing.md`. The H1 above is the full title.*
...
`docs/decisions/D363-the-cost-lines-on-the-two-sink-fade-entry-window-spread.md`
