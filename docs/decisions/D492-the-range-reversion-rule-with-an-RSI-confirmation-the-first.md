...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D492-the-range-reversion-rule-with-an-RSI-confirmation-the-first-declared-filter-set-on-the-D490-split-development-first-validation-once-if-the-bar-clears.md`. The H1 above is the full title.*
