# RESULT D460 — the construction rebuilt against the hand-drawn lines: the swing envelope loses, and the pivot construction re-dialled reaches the eye on gradient and most of the way on coverage

*Generators `scripts/d460_swing_envelope.py` (the swing envelope, with its dial sweep) and
`scripts/d460_hand_cell.py` (the winning cell); scorer `scripts/d451_score_hand_lines.py`; cards
`data/d460_swing_scorecard.json`, `data/d460_hand_scorecard.json`, `data/d451_hand_scorecard.json`
(the four earlier constructions, re-scored); target `data/d451_hand_drawn_lines.json`; page
...
break / replace / drift ends, `d460_swing_envelope.py`) was swept over 90 then 96 dial lines
...
| GROW (D451) | S / R | 61 / 62 | 80 / 79 | 49 / 70 | 5.5 / 5.8 | −3 / −2 | 93 / 89 | 53 / 50 |
| HYST (D452) | S / R | 53 / 52 | 73 / 79 | 54 / 48 | 5.5 / 5.2 | +2 / +1 | 83 / 85 | **16 / 19** |
| HYST-WIDE | S / R | **96 / 96** | 68 / 72 | 65 / 55 | 6.3 / 6.0 | −5 / −5 | 77 / 82 | 84 / 81 |
| **HAND CELL (D460)** | S / R | **69 / 71** | **92 / 87** | **27 / 40** | **3.2 / 4.3** | −5 / −5 | 86 / 86 | 42 / 31 |
...
No trade. The principal said not to. The next step, when wanted, is the D450 rule and the D434
rule on this cell — with the prediction already on record from D451/D452 that a better drawing
