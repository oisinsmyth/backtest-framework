...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D434-RESULT-volume-is-the-narrowest-axis-in-the-atlas-and-its-one-base-rate-is-a-short-side-drift-after-a-volume-shock.md`. The H1 above is the full title.*
