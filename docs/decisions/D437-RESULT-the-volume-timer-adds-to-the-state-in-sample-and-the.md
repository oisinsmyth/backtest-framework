...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D437-RESULT-the-volume-timer-adds-to-the-state-in-sample-and-the-book-cannot-pay-the-repos-own-spread.md`. The H1 above is the full title.*
