...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D491-PRE-REG-the-conditional-hold-exit-when-the-signal-flips-with-a-minimum-hold-time.md`. The H1 above is the full title.*
...
Every momentum record so far — [D484](D484-RESULT-the-log-MACD-is-a-real-signal-that-fails-only-on-cost.md),
[D486](D486-RESULT-cost-cutting-closes-70-percent-of-the-gap-and-stops-and.md),
[D488](D488-RESULT-extending-the-hold-fails-and-the-closure-accidentally.md)
