...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D484-PRE-REG-the-off-diagonal-lookback-and-the-log-impulse-MACD-as-momentum-signals.md`. The H1 above is the full title.*
...
and [D475](D475-RESULT-NO-TRANSFER-the-ES-gradient-was-in-sample-selection-and.md)
