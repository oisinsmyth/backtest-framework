...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D523-RESULT-the-trending-exception-is-RARER-than-chance-on-all-35-roots-and-gate-0a-passed-on-a-between-root-artefact.md`. The H1 above is the full title.*
