...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D531-PRE-REG-the-opening-range-breakout-on-each-root-s-own-session-gated-by-the-volume-EMA-over-SMA.md`. The H1 above is the full title.*
...
3. **Each root's own session.** [D530](D530-avenue-3-closed-the-leveraged-ETF-reset-flow-is-real-and.md)
...
[D529](D529-the-payoff-ratio-is-exit-geometry-the-hit-rate-is-the-edge-and.md)
