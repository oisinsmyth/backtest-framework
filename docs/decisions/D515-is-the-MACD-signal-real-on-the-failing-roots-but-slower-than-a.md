...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D515-is-the-MACD-signal-real-on-the-failing-roots-but-slower-than-a-seven-hour-window.md`. The H1 above is the full title.*
