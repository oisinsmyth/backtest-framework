...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D423-structure-exits-on-the-second-zone-the-first-bounce-as-target-the-tested-level-and-the-breach-both-lenses.md`. The H1 above is the full title.*
