...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D504-RESULT-stage-0-CLOSE-the-Asian-chip-channel-is-real-and-clears-entirely-in-the-gap-25-6-bp-into-the-gap-and-nothing-into-the-day-and-transports-beat-semis.md`. The H1 above is the full title.*
