...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D503-PRE-REG-the-one-pass-forward-read-K8-the-MACD-component-and-the-assembled-two-arm-book-on-the-sealed-2024-slice.md`. The H1 above is the full title.*
