...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D459-RESULT-beyond-22-hours-the-shape-constraints-lever-does-not-exist-at-the-frequency-the-rules-operate-on.md`. The H1 above is the full title.*

**MEASUREMENT record. No hurdle is claimed and no candidate is admitted.** Closes
[D458](D458-RESULT-the-hold-length-curve-has-no-identifiable-optimum-and.md)
...
- **What is NOT tested: a hold whose length is CONDITIONAL** rather than fixed. Every `k` here is a
  ...
  ([D442](D442-RESULT-O1-clears-the-ledgers-own-criterion-and-dies-inside-the.md))
