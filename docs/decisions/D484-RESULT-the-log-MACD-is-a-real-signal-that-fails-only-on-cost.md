...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D484-RESULT-the-log-MACD-is-a-real-signal-that-fails-only-on-cost-and-the-off-diagonal-ordering-is-confirmed.md`. The H1 above is the full title.*
...
pre-registration [D484 PRE-REG](D484-PRE-REG-the-off-diagonal-lookback-and-the-log-impulse-MACD-as.md),
