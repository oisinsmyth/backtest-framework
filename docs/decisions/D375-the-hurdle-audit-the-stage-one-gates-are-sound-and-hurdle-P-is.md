...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D375-the-hurdle-audit-the-stage-one-gates-are-sound-and-hurdle-P-is-half-untested.md`. The H1 above is the full title.*
...
threshold in force the question [D374](D374-RESULT-the-breadth-bar-was-unreachable-and-it-failed-the-most.md)
