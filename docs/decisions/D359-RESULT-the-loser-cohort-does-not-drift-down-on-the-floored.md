...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D359-RESULT-the-loser-cohort-does-not-drift-down-on-the-floored-universe.md`. The H1 above is the full title.*
