...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D473-RESULT-in-sample-K7-reproduces-exactly-the-09-30-exit-is-worse-not-better-and-seven-tenths-of-the-gated-P-L-follows-falls-of-more-than-1-percent-forward-read-not-run.md`. The H1 above is the full title.*
