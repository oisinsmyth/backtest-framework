...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D365-RESULT-the-momentum-buffer-clears-every-null-is-not-a-size-book-and-lives-in-era-2.md`. The H1 above is the full title.*
