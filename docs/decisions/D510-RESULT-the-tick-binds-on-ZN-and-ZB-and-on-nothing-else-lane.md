...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D510-RESULT-the-tick-binds-on-ZN-and-ZB-and-on-nothing-else-lane-21s-ES-claim-is-refuted-and-the-property-that-makes-them-predictable-is-what-makes-them-expensive.md`. The H1 above is the full title.*
...
**Pre-registration:** [`D510`](D510-PRE-REG-the-quoted-spread-census-on-bbo-1m-does-the-tick-BIND.md),
...
> same window, so [D489](D489-RESULT-ZB-IS-large-tick-and-the-sigma-that-failed-C-d-is-the.md)'s
...
3. **`C-d` and cost are separate axes and `P1` speaks only to cost.** Nothing here touches
   [D468](D468-RESULT-none-of-24-session-windows-on-eight-roots-clears-the.md)'s
