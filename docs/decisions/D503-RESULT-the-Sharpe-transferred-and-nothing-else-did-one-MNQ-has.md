...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D503-RESULT-the-Sharpe-transferred-and-nothing-else-did-one-MNQ-has-grown-into-the-barrier-and-the-book-is-worse-than-its-best-arm.md`. The H1 above is the full title.*
...
pre-registration [D503 PRE-REG](D503-PRE-REG-the-one-pass-forward-read-K8-the-MACD-component-and.md).
