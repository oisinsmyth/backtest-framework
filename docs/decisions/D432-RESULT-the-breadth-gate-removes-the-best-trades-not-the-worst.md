...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D432-RESULT-the-breadth-gate-removes-the-best-trades-not-the-worst-the-gap-structure-inverts-on-new-names-and-the-top-dollar-volume-tercile-nets-about-zero.md`. The H1 above is the full title.*
