...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D456-the-8-K-item-atlas-stage-0-every-corporate-event-type-on-the-dead-inclusive-fixture-coverage-counts-timeliness-co-occurrence-and-what-each-item-sits-in.md`. The H1 above is the full title.*
