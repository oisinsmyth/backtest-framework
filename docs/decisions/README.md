...
| [D179](D179-e1-on-the-combined-book.md) | E1 on BOTH legs of the combined book improves it by +0.114 / +0.197 Sharpe with both 90% intervals excluding zero — the first ensemble gain in this project that is measurable rather than noise, and it costs no new multiplicity | Committed | Analytics |
