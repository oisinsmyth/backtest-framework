...
| [D183](D183-the-cross-sectional-portfolio.md) | A cross-sectional long/short portfolio across 62 coins — diversification BETWEEN coins, which no study here has ever had; equal-weight return aggregation, with the un-modelled rebalancing cost stated | PRE-REGISTERED | Analytics |
