...
| [D186](D186-capacity-of-the-portfolio.md) | Capacity is ~$30M: the edge runs +0.067 at $100k, +0.014 at $10M and -0.026 at $100M. The strategy loses 5.3x more Sharpe to impact than the benchmark because its impact CONCENTRATES in the thin coins it trades | Committed (both predictions confirmed) | Analytics |
