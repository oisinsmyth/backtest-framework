...
| [D188](D188-the-etf-cross-section.md) | The same long baseline, unchanged, on 57 ETFs — D183's last debt and the only test that asks whether any of the portfolio result belongs to the rule rather than to one crypto decade | PRE-REGISTERED | Validation & research integrity |
