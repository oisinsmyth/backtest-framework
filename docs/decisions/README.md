...
| [D189](D189-the-s1-terrain-sensor-and-its-null.md) | Phase 3 opens: the S1 volume-profile sensor and the null-test harness whose verdict is a programme stop condition, with the primary configuration and the every-symbol bar named before the run | PRE-REGISTERED | Signals & strategy interface |
