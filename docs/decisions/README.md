...
| [D180](D180-e1-on-the-universe-pre-registration.md) | E1 vs no-E1 on the D140 universe, both books, k=3 fixed — with predictions committed first, and ties counted as ties because E1 is an added brick rather than a swapped one | PRE-REGISTERED | Validation & research integrity |
