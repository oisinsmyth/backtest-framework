...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D452-RESULT-D440-on-the-instrument-same-verdict-and-clustering-explains-94-percent-not-83.md`. The H1 above is the full title.*
...
**Continuing [D451](D451-RESULT-the-complete-acquisition-T1-is-testable-and-the-cash.md)
