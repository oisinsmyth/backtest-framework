...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D345-RESULT-the-event-book-fails-as-calibrated-and-the-target-exit-was-the-wrong-exit.md`. The H1 above is the full title.*
