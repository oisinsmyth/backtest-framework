...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D349-RESULT-every-short-signal-beats-its-own-names-at-random-times-and-still-loses.md`. The H1 above is the full title.*
