...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D491-RESULT-the-first-component-candidate-and-why-it-is-thinner-than-it-looks.md`. The H1 above is the full title.*
...
pre-registration [D491 PRE-REG](D491-PRE-REG-the-conditional-hold-exit-when-the-signal-flips-with-a.md),
