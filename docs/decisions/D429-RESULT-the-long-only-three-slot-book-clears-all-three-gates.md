...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D429-RESULT-the-long-only-three-slot-book-clears-all-three-gates-and-the-candidate-condition-is-met-with-its-caveat-attached.md`. The H1 above is the full title.*
