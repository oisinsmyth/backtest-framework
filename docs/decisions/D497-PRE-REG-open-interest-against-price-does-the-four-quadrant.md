...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D497-PRE-REG-open-interest-against-price-does-the-four-quadrant-read-carry-a-signed-day-session-edge-on-ES-NQ-CL-and-GC.md`. The H1 above is the full title.*
