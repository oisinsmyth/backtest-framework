...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D426-RESULT-the-first-touch-that-gets-doubled-is-already-three-percent-underwater-and-nothing-done-to-it-afterwards-matters.md`. The H1 above is the full title.*
