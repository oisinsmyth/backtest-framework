# RESULT D477 — the ceiling: perfect lines pay only because they know the future, the causal lines pay nothing, and steeper trends are *worse* in real time

*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D477-RESULT-the-ceiling-perfect-lines-pay-only-because-they-know-the-future-and-the-causal-lines-pay-nothing.md`. The H1 above is the full title.*

*Runner `scripts/run_d477_oracle_ceiling.py`; numbers `data/d477_oracle_ceiling.json`; the oracle
page the settings were chosen on is artifact 3216fed4 ("Perfect Hindsight"). Sequel to
[D476](D476-RESULT-the-channel-traded-is-worse-than-re-timing-its-own.md). Nothing is
...
- **The causal long side is positive and small: +16.8 ± 5.5 bp gross (t = 3.1), median −125,
  ...
  side is negative at eight SE. Same shape as D476, with a simpler rule.
- **Steeper is worse, causally — and better, in hindsight.** The oracle's gross rises monotonically
  ...
  agree on a steep slope, the leg is late. This is the cleanest statement yet of why D476 sat
...
(D476 with a target and trail, D477 without). It does not close the avenue.
