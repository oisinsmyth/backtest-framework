...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D351-RESULT-D347s-control-A-was-trading-the-excluded-tail-three-long-signals-beat-their-own-names-on-the-floor.md`. The H1 above is the full title.*
