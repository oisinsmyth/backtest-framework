...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D462-RESULT-ES-NQ-YM-one-minute-fixtures-pass-five-gates-from-2016-the-archive-lacks-the-index-futures-day-session-before-then-and-RTY-is-held-back-on-one-limit-down-day.md`. The H1 above is the full title.*
