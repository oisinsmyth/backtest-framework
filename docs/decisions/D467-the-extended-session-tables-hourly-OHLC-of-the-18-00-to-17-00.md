...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D467-the-extended-session-tables-hourly-OHLC-of-the-18-00-to-17-00-Globex-session-on-eight-roots-front-by-volume-with-five-gates.md`. The H1 above is the full title.*
