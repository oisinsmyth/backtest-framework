...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D344-RESULT-the-hold-is-a-cost-lever-k40-nets-5-and-turnover-is-not-1-over-k.md`. The H1 above is the full title.*
