...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D355-RESULT-the-target-fires-first-the-invalidation-exit-lengthens-the-hold-and-the-target-stays.md`. The H1 above is the full title.*
