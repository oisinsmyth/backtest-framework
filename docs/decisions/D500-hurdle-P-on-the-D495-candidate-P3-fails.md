# D500 — hurdle P on the D495 candidate: **P3 fails**

**2026-09-12.** Runner [`scripts/d500_candidate_hurdle_p.py`](../../scripts/d500_candidate_hurdle_p.py) ·
artifact [`data/d500_candidate_hurdle_p.json`](../../data/d500_candidate_hurdle_p.json).
