...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D522-the-RTY-G4-failure-was-one-halted-open-not-a-fixture-defect-and-the-gate-now-says-so.md`. The H1 above is the full title.*
