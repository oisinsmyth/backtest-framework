...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D475-PRE-REG-does-the-volatility-conditioned-continuation-gradient-TRANSFER-to-seven-instruments-it-was-never-seen-on.md`. The H1 above is the full title.*

**2026-09-12, committed before the runner exists** (CLAUDE.md, [R8](../RULES.md#r8)).
Follow-up to [D474 RESULT](D474-RESULT-the-pre-registered-bar-was-not-met-but-four-of-five.md),
