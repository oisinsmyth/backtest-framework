...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D490-RESULT-the-range-reversion-rule-loses-gross-on-both-sides-and-both-roots-a-stale-range-beats-yesterdays-and-three-fifths-of-the-longs-are-breakdowns-below-the-low.md`. The H1 above is the full title.*
