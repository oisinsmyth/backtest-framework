...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D528-the-mean-reversion-oracle-does-a-rare-excursion-return-to-its-level-more-reliably-than-its-own-sign-shuffle.md`. The H1 above is the full title.*
