...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D504-stage-0-the-Asian-chip-session-into-the-US-semiconductor-day-does-Taiwan-and-Korea-carry-information-the-US-semis-gap-has-not-priced.md`. The H1 above is the full title.*
