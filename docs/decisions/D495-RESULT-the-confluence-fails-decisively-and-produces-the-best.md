...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D495-RESULT-the-confluence-fails-decisively-and-produces-the-best-cell-anyway.md`. The H1 above is the full title.*
...
pre-registration [D495 PRE-REG](D495-PRE-REG-does-requiring-the-two-MACD-variants-to-AGREE-help-and.md).
