...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D507-the-spread-census-on-all-41-roots-micros-quote-tighter-than-their-parents-and-the-1-009-assumption-was-wrong-by-up-to-twelve-fold.md`. The H1 above is the full title.*
...
Extends [D510](D510-RESULT-the-tick-binds-on-ZN-and-ZB-and-on-nothing-else-lane.md),
...
**HG is eliminated.** [D506 §9](D506-RESULT-the-MACD-arm-does-not-transplant-one-root-of-35-clears.md)
