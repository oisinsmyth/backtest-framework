...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D472-RESULT-the-volume-clock-exit-replicates-8-of-8-years-but-the-15-minute-horizon-does-not-survive-its-own-scoring-window.md`. The H1 above is the full title.*
...
[D471 AMENDMENT 2](D471-RESULT-the-spread-barely-widens-where-the-moves-are-and-path.md)
