...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D358-the-flat-by-default-sleeve-a-trigger-a-market-hedge-and-the-deployed-base.md`. The H1 above is the full title.*
...
`docs/decisions/D358-the-flat-by-default-sleeve-a-trigger-a-market-hedge-and-the.md`
