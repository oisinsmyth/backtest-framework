...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D471-RESULT-the-spread-barely-widens-where-the-moves-are-and-path-efficiency-is-exactly-the-random-walk-value-in-every-bucket.md`. The H1 above is the full title.*
...
Two questions, both raised by [D469](D469-RESULT-the-scalping-re-cost-the-spread-is-not-what-kills-it-a.md):
