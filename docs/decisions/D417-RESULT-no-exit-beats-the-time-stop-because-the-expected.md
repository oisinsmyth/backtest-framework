...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D417-RESULT-no-exit-beats-the-time-stop-because-the-expected-remaining-move-is-never-negative.md`. The H1 above is the full title.*
