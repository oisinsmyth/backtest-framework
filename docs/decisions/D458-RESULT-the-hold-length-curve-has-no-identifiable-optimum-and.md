...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D458-RESULT-the-hold-length-curve-has-no-identifiable-optimum-and-the-observed-argmax-is-below-its-own-nulls-MEDIAN.md`. The H1 above is the full title.*
...
[D452](D452-RESULT-D440-on-the-instrument-same-verdict-and-clustering.md)
...
> **This is [D442's addendum](D442-ADDENDUM-the-two-apparent-wins-were-selection-across-four-risk.md)
...
measured at 82–86%, [D442](D442-RESULT-O1-clears-the-ledgers-own-criterion-and-dies-inside-the.md)
saw in its bootstrap centre, and [D452](D452-RESULT-D440-on-the-instrument-same-verdict-and-clustering.md)
