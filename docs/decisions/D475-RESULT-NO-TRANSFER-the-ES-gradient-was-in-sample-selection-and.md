...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D475-RESULT-NO-TRANSFER-the-ES-gradient-was-in-sample-selection-and-the-sign-flips-on-seven-unseen-roots.md`. The H1 above is the full title.*
...
pre-registration [D475 PRE-REG](D475-PRE-REG-does-the-volatility-conditioned-continuation-gradient.md),
...
continuation** — consistent with [D471 AMENDMENT 1](D471-RESULT-the-spread-barely-widens-where-the-moves-are-and-path.md)'s
...
- Combined with [D473](D473-RESULT-the-cost-structure-picks-the-horizon-hours-not-minutes.md)
  §4 (variance ratio ≤ 1.02 on nine grids across two clocks) and
  [D474](D474-RESULT-the-pre-registered-bar-was-not-met-but-four-of-five.md)
