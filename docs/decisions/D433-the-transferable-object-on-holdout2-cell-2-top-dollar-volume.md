...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D433-the-transferable-object-on-holdout2-cell-2-top-dollar-volume-both-sides-with-sharpe-one-read.md`. The H1 above is the full title.*
