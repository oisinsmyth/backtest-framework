...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D413-ADDENDUM-3-cell-2-decays-monotonically-and-the-level-gap-does-not.md`. The H1 above is the full title.*
...
**The cell is fixed exactly as [ADDENDUM 2](D413-ADDENDUM-2-the-cost-estimate-was-wrong-and-path-efficiency.md)
