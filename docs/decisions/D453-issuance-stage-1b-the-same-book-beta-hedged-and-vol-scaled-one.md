...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D453-issuance-stage-1b-the-same-book-beta-hedged-and-vol-scaled-one-declared-change-same-three-controls-same-bar.md`. The H1 above is the full title.*
