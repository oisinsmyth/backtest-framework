...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D437-shock-with-state-stage-1-the-in-sample-event-study-and-the-weighted-book.md`. The H1 above is the full title.*
