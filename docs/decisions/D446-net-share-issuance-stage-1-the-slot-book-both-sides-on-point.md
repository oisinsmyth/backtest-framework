...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D446-net-share-issuance-stage-1-the-slot-book-both-sides-on-point-in-time-EDGAR-counts-with-three-controls-declared.md`. The H1 above is the full title.*
