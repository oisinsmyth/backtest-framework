...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D457-the-8-K-item-atlas-with-returns-17-cells-both-sides-cap-10-state-matched-and-rotation-controls-on-every-cell-the-2024-slice-stays-shut.md`. The H1 above is the full title.*
