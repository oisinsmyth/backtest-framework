...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D387-RESULT-no-signal-the-edge-is-reversion-from-x-alone-and-cost-buries-it.md`. The H1 above is the full title.*
