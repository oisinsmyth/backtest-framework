...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D380-RESULT-no-exit-overlay-beats-not-cutting-and-R7s-control-inherits-the-rule.md`. The H1 above is the full title.*
...
[D378](D378-RESULT-the-entry-day-does-matter-and-it-survives-losing-its.md), which found
...
**This is [D374](D374-RESULT-the-breadth-bar-was-unreachable-and-it-failed-the-most.md)'s
