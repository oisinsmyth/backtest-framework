...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D363-RESULT-the-entry-day-spread-is-a-fifth-narrower-at-the-median-and-no-narrower-at-the-mean-the-cost-question-is-execution-not-estimation.md`. The H1 above is the full title.*
