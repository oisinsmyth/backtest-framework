...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D510-PRE-REG-the-quoted-spread-census-on-bbo-1m-does-the-tick-BIND-and-does-the-spread-rank-the-roots-the-way-tau-did.md`. The H1 above is the full title.*
...
[R15](../RULES.md#r15) call [D489 §7.4](D489-RESULT-ZB-IS-large-tick-and-the-sigma-that-failed-C-d-is-the.md)
...
[D468](D468-RESULT-none-of-24-session-windows-on-eight-roots-clears-the.md)
...
- **`S1` — the AGREEMENT test.** Spearman rank correlation between the eight roots' `P1` ordering
  ...
  - **TIE CLAUSE, declared now:** **if five or more of the eight roots have `P1` ≥ 0.95, `S1` is
    ...
    ceiling identifies nothing — this is [D461 §4](D461-RESULT-stage-0-ABANDONED-the-hour-is-a-decay-from-the-cash.md)'s
