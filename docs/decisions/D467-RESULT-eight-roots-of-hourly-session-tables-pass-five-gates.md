...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D467-RESULT-eight-roots-of-hourly-session-tables-pass-five-gates-from-2016-after-two-gate-amendments-on-holiday-prints-and-the-partial-pre-2016-sessions.md`. The H1 above is the full title.*
