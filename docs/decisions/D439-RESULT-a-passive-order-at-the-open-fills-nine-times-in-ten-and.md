...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D439-RESULT-a-passive-order-at-the-open-fills-nine-times-in-ten-and-recovers-two-thirds-of-the-modelled-half-spread-net-of-the-chase.md`. The H1 above is the full title.*
