...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D526-the-curve-story-fails-stage-0-the-level-is-a-regime-and-the-change-carries-nothing.md`. The H1 above is the full title.*
...
> **THAT PREMISE IS WRONG, corrected the same day by [D529](D529-the-payoff-ratio-is-exit-geometry-the-hit-rate-is-the-edge-and.md).**
