...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D461-RESULT-stage-0-ABANDONED-the-hour-is-a-decay-from-the-cash-close-and-a-minute-with-no-rule-outranks-both-targets.md`. The H1 above is the full title.*
