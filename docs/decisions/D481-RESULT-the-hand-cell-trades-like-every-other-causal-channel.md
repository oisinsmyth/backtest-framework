...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D481-RESULT-the-hand-cell-trades-like-every-other-causal-channel-plus-12-bp-gross-below-its-own-rotation-null.md`. The H1 above is the full title.*
