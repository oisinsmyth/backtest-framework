...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D414-RESULT-the-15m-touch-is-35bp-too-early-in-the-one-cell-that-mattered.md`. The H1 above is the full title.*
...
[ADDENDUM 3](D413-ADDENDUM-3-cell-2-decays-monotonically-and-the-level-gap-does.md) found
