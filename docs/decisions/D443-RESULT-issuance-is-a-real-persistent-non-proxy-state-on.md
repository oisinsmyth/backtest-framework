...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D443-RESULT-issuance-is-a-real-persistent-non-proxy-state-on-survivors-and-the-vendor-serves-none-of-the-562-dead-names-abandoned-on-A1.md`. The H1 above is the full title.*
