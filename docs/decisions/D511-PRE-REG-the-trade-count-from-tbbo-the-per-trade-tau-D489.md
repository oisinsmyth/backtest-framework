...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D511-PRE-REG-the-trade-count-from-tbbo-the-per-trade-tau-D489-declared-it-could-not-compute.md`. The H1 above is the full title.*
...
[D489's amendment](D489-PRE-REG-stage-0-is-ZB-actually-a-large-tick-instrument-the.md)
and [D510 §7](D510-RESULT-the-tick-binds-on-ZN-and-ZB-and-on-nothing-else-lane.md).
