...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D381-RESULT-a-stop-is-a-late-trigger-and-the-median-mean-exchange-rate-is-fixed.md`. The H1 above is the full title.*
...
**Corrects:** [D380 §6a](D380-RESULT-no-exit-overlay-beats-not-cutting-and-R7s-control.md), whose ±200 bp thresholds fired on ~80% of trades.
...
size. [D379](D379-the-prop-account-is-a-down-and-out-call-and-hurdle-P-has-no.md)
...
[D375 §5](D375-the-hurdle-audit-the-stage-one-gates-are-sound-and-hurdle-P-is.md)
...
Combined with [D378](D378-RESULT-the-entry-day-does-matter-and-it-survives-losing-its.md),
