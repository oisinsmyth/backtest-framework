...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D425-exits-read-off-the-detected-zones-the-next-live-zone-as-target-and-new-zones-as-a-trailing-stop-both-lenses.md`. The H1 above is the full title.*
