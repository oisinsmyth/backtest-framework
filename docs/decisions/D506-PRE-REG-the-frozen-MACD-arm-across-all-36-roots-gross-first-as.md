...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D506-PRE-REG-the-frozen-MACD-arm-across-all-36-roots-gross-first-as-one-family.md`. The H1 above is the full title.*
...
**Imported unchanged** from [D484](D484-RESULT-the-log-MACD-is-a-real-signal-that-fails-only-on-cost.md)
(signal) and [D491](D491-RESULT-the-first-component-candidate-and-why-it-is-thinner.md)
