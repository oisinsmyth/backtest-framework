...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D511-RESULT-three-independent-measurements-order-the-eight-roots-IDENTICALLY-and-ZN-needs-261-trades-to-move-one-tick-while-one-NQ-trade-moves-two.md`. The H1 above is the full title.*
...
**Pre-registration:** [`D511`](D511-PRE-REG-the-trade-count-from-tbbo-the-per-trade-tau-D489.md),
...
two.** This is [D510 §6](D510-RESULT-the-tick-binds-on-ZN-and-ZB-and-on-nothing-else-lane.md)'s
