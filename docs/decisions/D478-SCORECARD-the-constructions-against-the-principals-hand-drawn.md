# D478 SCORECARD — the constructions against the principal's hand-drawn lines: pivots get the gradient, windows get the coverage, nothing gets both

*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D478-SCORECARD-the-constructions-against-the-principals-hand-drawn-lines-pivots-get-the-gradient-windows-get-the-coverage-nothing-gets-both.md`. The H1 above is the full title.*

*Scorer `scripts/d478_score_hand_lines.py`; numbers `data/d478_hand_scorecard.json`; the target
`data/d478_hand_drawn_lines.json`, drawn on the page "Draw the Lines" (artifact 1ed889fb) one bar
...
| GROW (D478) | support | 61% | 74% | 80% | 49% | 5.5% | −3 | 93% | 40% |
| | resistance | 62% | 76% | 79% | 70% | 5.8% | −2 | 89% | 39% |
| HYST (D479) | support | 53% | 75% | 73% | 54% | 5.5% | 2 | 83% | 26% |
