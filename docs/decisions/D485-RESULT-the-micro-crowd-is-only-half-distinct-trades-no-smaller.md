...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D485-RESULT-the-micro-crowd-is-only-half-distinct-trades-no-smaller-than-the-E-mini-crowd-leaves-no-flatten-fingerprint-and-its-excess-flow-clears-no-family-bar.md`. The H1 above is the full title.*

**2026-09-12.** Spec [D485 PRE-REG](D485-PRE-REG-retail-flow-stage-0-is-the-micro-contract-crowd-a.md)
