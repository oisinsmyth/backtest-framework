...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D469-RESULT-the-scalping-re-cost-the-spread-is-not-what-kills-it-a-fixed-commission-against-a-tenth-sized-tick-is.md`. The H1 above is the full title.*
...
[D465 AMENDMENT 3](D465-RESULT-the-cost-line-was-never-what-killed-C1-crossing-costs-a.md);
...
[D471](D471-RESULT-the-spread-barely-widens-where-the-moves-are-and-path.md)
