...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D463-RESULT-market-intraday-momentum-is-a-third-of-its-published-size-on-ES-2016-2023-and-not-distinguishable-from-zero-and-hurdle-P-computed-for-the-first-time-fails-on-size-at-every-f.md`. The H1 above is the full title.*
