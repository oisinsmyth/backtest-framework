...
*Filename shortened 2026-09-17 ([D540](D540-local-config-a-clone-never-receives.md)); was `D488-RESULT-extending-the-hold-fails-and-the-closure-accidentally-produced-the-first-net-positive-cell.md`. The H1 above is the full title.*
...
pre-registration [D488 PRE-REG](D488-PRE-REG-does-the-MACD-edge-keep-growing-with-the-holding.md),
