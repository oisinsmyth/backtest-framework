...
(2026-09-16). [`data/data_manifest.json`](../data/data_manifest.json) carries the sha256 of all 123
panels and the git blob id of **115** of them. The eight without one —
...
same day, `data/fixtures/cme_session_calendar.csv.gz` — were never tracked in the first place, so
