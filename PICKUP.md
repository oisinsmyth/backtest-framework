...
| **The market-structure avenue** | **D382 closed the daily ETF screen** — the family is market drift. **D384's close was WITHDRAWN** (wrong statistic, `n_eff` 14.5). **D385 re-ran it properly: 1 of 2,592 cells clears, with `n_eff` 57.7–227.6 and ADEQUATE. §10's close condition is MET — the decision is the PRINCIPAL'S (R15).** The one emphatic signal in it was an artefact of the study's own tying rule. [FINDINGS §54](docs/FINDINGS.md) |
