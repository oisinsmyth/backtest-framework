...
| **The market-structure avenue** | **D382 closed the daily ETF screen** — the family is market drift. **D384's close is WITHDRAWN**: it compared ONE density at the final mining bar, not §4's per-bar sampled-and-pooled statistic, and `n_eff` is **14.5 bars at half-life 5** on a 481-point grid. P1 failed for want of power. **The density family is NOT closed and needs a re-run.** [FINDINGS §53](docs/FINDINGS.md) + amendment |
