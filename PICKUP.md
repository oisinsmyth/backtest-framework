...
| **Two things D385 did NOT test, both flagged** | **rare event types** (reversals 2.4/100, moves >2% 4.0/100) were excluded by *my* narrowing, declared for objection and never run; and the principal's **decay-coherence fork** was parked with a scaffold and is OPEN |
