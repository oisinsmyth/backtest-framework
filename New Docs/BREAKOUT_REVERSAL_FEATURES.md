...
## Reporting
Extend BREAKOUT_RESULTS.md with a "Feature analysis" section: outcome-by-quintile tables per feature, monotonicity/stability verdicts, and an explicit ranked shortlist of features meeting promotion criteria. State clearly which hypotheses were falsified — a clean negative result is a valid and reportable outcome.
